...
### Added
- `START-HERE.md` — plain-language setup guide for non-developers. Includes a copy-paste prompt for Claude, ChatGPT, or Gemini to walk users through integration one step at a time. Available in English, Chinese, and Thai.
